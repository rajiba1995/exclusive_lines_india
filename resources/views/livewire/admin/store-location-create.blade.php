                        ...
                        <form wire:submit.prevent="store">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-10">
                                            <input type="text" wire:model="contact_numbers.{{ $index }}"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-10">
                                            <input type="text" wire:model="operating_time.{{ $index }}.time"
                                                placeholder="10:30am – 9pm, 7 days a week" class="form-control">
                                            @error("operating_time.$index.time")
                                            <p class="text-danger inputerror">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="col-md-2 d-flex align-items-start gap-2">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="selectBrands" multiple class="form-control" wire:model="selectedBrands">
                                        ...
                                        <option value="{{ $brand->name }}" {{ in_array($brand->name, $selectedBrands) ?
                                            'selected' : '' }}>
                                            {{ $brand->name }}
                                        </option>
                                        @endforeach
